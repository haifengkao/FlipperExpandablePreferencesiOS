...
#import "FKExpandableUserDefaultsPlugin.h"
#import <FlipperKit/FlipperConnection.h>
#import <FlipperKit/FlipperResponder.h>
#import "FKExpandableUserDefaultsSwizzleUtility.h"
...
@interface FKExpandableUserDefaultsPlugin ()
...
@implementation FKExpandableUserDefaultsPlugin

- (instancetype)init {
  if (self = [super init]) {
    _standardUserDefaults = [NSUserDefaults standardUserDefaults];
    __weak typeof(self) weakSelf = self;
    [FKExpandableUserDefaultsSwizzleUtility
